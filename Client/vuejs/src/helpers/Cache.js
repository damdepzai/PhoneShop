...
export default function () {
    ...
    const CACHE_SUFFIX = '-cache-expiration';
    ...
    function supportsStorage() {
        ...
        try {
            ...
            cachedStorage = !!(isOutOfSpace(e) && localStorage.length);
        }
        return cachedStorage;
    }
    ...
    function warn(message, err) {
        ...
        window.console.warn("cache - " + message);
        if (err) window.console.warn("cache - The error was: " + err.message);
    }
    ...
    return {
         ...
         * @param {number} time
         * @return boolean true if the value was inserted successfully
         */
        ...
        /**
         * Flushes all cache items and expiry markers without affecting rest of localStorage
         */
        flush: function () {
            if (!supportsStorage()) return;
        ...
        /**
         * Flushes expired cache items and expiry markers without affecting rest of localStorage
         */
        ...
        /**
         * Appends CACHE_PREFIX so cache will partition data in to different buckets.
         * @param {string} bucket
         */
        ...
        /**
         * Resets the string being appended to CACHE_PREFIX so cache will use the default storage behavior.
         */
